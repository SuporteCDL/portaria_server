import { createEntry, getEntries, getEntriesByDay, getEntriesByPeriod, getEntriesAmountDays, getEntriesByLocal, removeEntry, updateEntry, getEntriesByUser } from "./entries.controller.js";
export const entryRoutes = async (app) => {
    app.get('/', getEntries);
